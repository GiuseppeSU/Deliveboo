...
@section('content')
    <div class="mt-5">
        <div class="row d-flex justify-content-center container_info ">
            <div class="card_container col-sm-6 col-md-3 mb-3 p-5">
                <img class="w-50" src="img/register.svg" alt="Registrati">
                <h3>DeliveBoo</h3>
            ...
            <div class="card_container col-sm-6 col-md-3 mb-3  p-5">
                <img class="w-25 align-items-center" src="img/add.png" alt="Aggiungi i tuoi piatti">
            ...
            <div class="card_container col-sm-6 col-md-3 mb-3  p-5">
                <img class="w-25" src="img/sale.png" alt="Registrati">
    ...
    <div class="general_container p-3">
        <div class="row d-flex justify-content-center  ">
            <div class="card_container col-sm-6 col-md-3 mb-3  p-5">
                <img class="w-25" src="img/register.png" alt="Registrati">
                <h3>Registrati</h3>
